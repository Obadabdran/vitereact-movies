  ...
  return (
    <>
      ...
      <img className=" w-60 h-80 rounded-md -mt-3" src={`https://image.tmdb.org/t/p/w500${props.image}`}/>
        ...
        <Link className=" absolute -bottom-3 border border-slate-700 bg-slate-800 px-2 rounded-xl  hover:bg-white hover:text-slate-800" to='/details' onClick={handleDetails}>Watch/Download</Link>
      </div>
    </>
  )
}
