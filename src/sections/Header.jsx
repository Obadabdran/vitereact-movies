...
import logo from '../assets/symbol.jpg'
      ...
      <>
        <div className="mx-auto max-w-7xl  px-2 sm:px-6  lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 -ml-6 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex flex-shrink-0 items-center ml-2">
                <img
                  ...
                  alt="Your Company"
                />
                <h2 className='text-white font-mono ml-2'>MoviesTime</h2>
              </div>
